...
<?php
$sql = "SELECT staffid, CONCAT(firstname, ' ', lastname) AS name, username, address, emailaddress, phone, usertype FROM tblstaff";
...
<div class="wrapper">
  ...
  <div id="content">
    ...
    <div class="status-area container-fluid">
      ...
      <a href='add_delivery.php'><button class='btn btn-primary btn-xs'>Add Employee</button></a>
    </div>
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <form action="delete_delete.inc.php" method="POST">
